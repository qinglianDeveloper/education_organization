 ...
 * @LastEditors: sueRimn
 * @LastEditTime: 2020-04-28 23:44:40
 -->
<template>
  <Form ref="formValidate" :model="formValidate" :rules="ruleValidate" :label-width="100">
    ...
    <FormItem label="佳信用户名:" prop="jxUsername">
      <Input v-model="formValidate.jxUsername" />
    </FormItem>
    <FormItem label="佳信密码:" prop="jxPassword">
      <Input v-model="formValidate.jxPassword" type="password" />
    </FormItem>
  </Form>
</template>
<script>
