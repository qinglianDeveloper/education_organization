 ...
 * @LastEditors: sueRimn
 * @LastEditTime: 2020-05-19 09:47:14
 -->
<template>
  <Form
    ref="formValidate"
  ...
  >
    <div class="twoitem">
      <FormItem label="所属区域代理:" prop="agentCompanyName">
        <Input :disabled="isEdit" class="input" v-model="form.agentCompanyName"></Input>
      </FormItem>
    ...
    <FormItem label="二级佣金比例:" prop="commissionRate">
      <div style="display:flex">
        <div style="margin-right:20px">
          <Input
            style="width:140px;margin-right:2px"
            v-model="form.commissionRate.ratioTop"
            placeholder="区域代理比例"
          />
        ...
        <div style="margin-right:20px">
          <Input
            style="width:140px;margin-right:2px"
            v-model="form.commissionRate.ratioSecond"
            placeholder="直销代理比例额"
          />
          <span style="font-weight:bold">%</span>
        </div>
        <div style="margin-right:20px">
          <Input
            style="width:140px;margin-right:2px"
            v-model="form.commissionRate.ratioCustomer"
            placeholder="用户比例"
          />
          <span style="font-weight:bold">%</span>
        </div>
...
export default {
  ...
  data() {
    const validDefault = (rule, value, callback) => {
      ...
      let customer = value.ratioCustomer * 1;
      var regPos = /^\d+(\.\d+)?$/;
      var regFlot = /^-?\d+\.?\d{0,2}$/;
      if (!value.ratioTop) {
        ...
        !regFlot.test(value.ratioSecond) ||
