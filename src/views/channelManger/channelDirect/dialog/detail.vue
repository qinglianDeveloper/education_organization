 ...
 * @version: 
 * @Author: sueRimn
 * @Date: 2020-04-30 14:51:13
 * @LastEditors: sueRimn
 * @LastEditTime: 2020-05-06 14:09:56
 -->
<template>
  <Modal
  ...
  >
    <Form ref="formValidate" :model="form" :label-width="140" style="height:600px;overflow:auto">
      <div class="twoitem">
        <FormItem label="所属区域代理:" prop="agentCompanyName" class="item">
          <span>{{form.agentCompanyName}}</span>
        </FormItem>
...
export default {
  ...
  methods: {
    getFormInfo() {
      getByDirectId({ id: this.detailId }).then(res => {
        if (res.code == 200) {
